...
/**
 * Class AbstractStringEnum
 * @package coffeephp\enum
 * @since 2020-07-28
 * @author Danny Damsky <dannydamsky99@gmail.com>
 */
abstract class AbstractStringEnum implements EnumInterface
{
    ...
    /**
     * AbstractStringEnum constructor.
     * @param string $key
     * @param string $value
     */
    final protected function __construct(private string $key, private string $value)
    {
    }
