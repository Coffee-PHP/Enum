 ...
 *
 * Represents a nullable floating-point enumerable object.
 *
 * @package coffeephp\enum
 * @since 2020-07-28
 * @author Danny Damsky <dannydamsky99@gmail.com>
 * @property-read string $name
 * @property-read float|null $value
 */
abstract class AbstractNullableFloatEnum
{
    /**
     ...
     *
     * @return iterable<string, float|null>
    ...
    /**
     * Nullable floating-point enumerable constructor.
     *
     * @param string $name
